    ...
    <div className="flex h-screen animate-fade-in">
      ...
      <div className="w-1/2 bg-white flex flex-col items-start p-10">
        ...
        <div className="max-w-md">
          <h1 className="text-4xl font-bold mb-6 text-gray-800">TakeIt</h1>
          <p className="text-xl mb-8 text-gray-600">La gestion de projet simplifiée</p>
      ...
      <div className="w-1/2 bg-gradient-to-br from-[#003DA5] via-[#0052CC] to-[#0065FF] flex justify-center items-center animate-scale-in">
        <div className="w-full max-w-md p-8 space-y-8 bg-white/10 backdrop-blur-sm rounded-lg text-white">
